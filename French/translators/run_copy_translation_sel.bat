...
SET _dst=D:\Android\Github\HyperOS-XML-1.0-FRENCH\French\main\%_APKFILE%.apk\res\values-fr%_EXT%\
SET _dat=D:\Android\Github\HyperOS-XML-1.0-FRENCH\French\translators\
